(defproject elso "0.1.0-SNAPSHOT"
  ...
  :ring {:handler elso.handler/app
         :uberwar-name "elso.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "elso.jar"
  :main elso.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "elso.core/mount-root"}
             :compiler
             {:main "elso.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns elso.repl}
